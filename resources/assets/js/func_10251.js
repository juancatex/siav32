...
export function _vvp2521_cr01(ta,fotocr,funn, idview = 'planout') {
  ...
  export function _vvp2521_acreditados(ta,fotocr,funn, idview = 'planout') {
    ...
    getDataUri(ta.rutafoto.length>2?ta.rutafoto:fotocr.avatar, function (fotosocio) {
      ...
      doc.setFontStyle('normal');
      doc.setTextColor(0,0,0); 
      centrarTextTo2n(doc, ta.nomgrado.toUpperCase(),0,4.9);  
      centrarTextTo2n(doc, ta.nombres.toUpperCase(), 0,5.3); 
      centrarTextTo2n(doc,(ta.apaterno+" "+ta.amaterno).toUpperCase(), 0,5.7); 
      doc.setFontStyle('normal');
      doc.setFontSize(7); 
      doc.setFontSize(6);
  ...
  export function _vvp2521_acreditados2(ta,fotocr,funn, idview = 'planout') {
    $("#" + idview).attr("src",''); 
    $("#2" + idview).attr("src",''); 
    let fondo=fotocr.foto; 
    let fondodos=fotocr.fotoa; 
    getDataUri(ta.rutafoto.length>2?ta.rutafoto:fotocr.avatar, function (fotosocio) {
      ...
      doc.setFontStyle('normal');
      doc.setTextColor(52,52,52);
          centrarTextTo2(doc,ta.nomgrado.toUpperCase(), 8.05,6.4);  
          centrarTextTo2(doc, ta.nombres.toUpperCase(), 8.45,6.4); 
          centrarTextTo2(doc,(ta.apaterno+" "+ta.amaterno).toUpperCase(), 8.85,6.4);
    
      doc.setFontSize(13);     
      doc.setFontStyle('bold');
      // doc.setFontSize(7); 
      
      centrarTextTo2(doc,'XV REUNION', 9.7,6.4);  
      centrarTextTo2(doc,'NACIONAL', 10.53,6.4); 
       
      doc.setFontSize(6);
      doc.text(ta.ci+' '+ta.ext, 7.24, 4.1,null,90);
      doc.text(ta.fuerza==1?'Armada':(ta.fuerza==2?'Ejercito':'Aerea'), 7.46, 4.1,null,90);
