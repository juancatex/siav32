        ...
        <div class="modal-dialog modal-primary modal-sm">
            <div class="modal-content animated fadeIn">
                ...
                <div class="modal-body">
                    Código
                    <input type="text" class="form-control" v-model="codunidad" >
                    Nombre de la Unidad: <span class="txtasterisco"></span>
                    ...
                    <div class="txtvalidador text-right">* Datos obligatorio</div>
                </div>
...
export default {
    ...
    methods:{
        ...
        valUnidad(){
            this.completo=0;
            if((this.nomunidad)) this.completo=1;
        },
        ...
        estadoUnidad(unidad){
            this.idunidad=unidad.idunidad;
            if(unidad.activo)
                swal({title:'Desactivará la unidad '+unidad.nomunidad, type:'warning',
                    ...
                    if(respuesta.value) this.switchUnidad(1);
                });
            else this.switchUnidad(0);
        },
