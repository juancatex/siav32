    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Configuracion evento - tipo comprobante
            ...
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <strong class="col-md-4 form-control-label" style="margin-bottom: 0px;margin-top: 8px;" >Tipo de Evento:</strong>
                ...
                <table class="table table-bordered table-striped table-sm">
                    ...
                    <template v-if="relacion=='LB' || (arrayResRelaciones.length==0 && relacion!=0)">
                        <tr>
                            ...
                            <td><select name="tipocomprobante" id="" v-model="idcomprobante">
...
export default {
    data (){
        return {
            relacion:0,
            arrayRelacion:[{abreviacion:"CCUENTA",descripcion:"Cargo de Cuenta"},
                          {abreviacion:"DCUENTA",descripcion:"Descargo de Cargo de Cuenta"}],
