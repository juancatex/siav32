...
<div style="display:none" id="divMausoleo">
    <div class="card" v-if="divAmbientes">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6 titcard" style="text-transform:uppercase">
                ...
                <div class="col-md-6 text-right" style="padding-top:8px">
                    ...
                    <div class="input-group-append"  style="display:inline">
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                            Sarcófagos<span class="caret"></span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end">
                ...
                <table align="center">
                    <tr><td v-for="fsa in regServicio.bloquesfosa" :key="fsa" class="bloquefila" style="padding:10px">
                        <table class="table-bordered">
                            ...
                            <tr v-for="ambiente in arrayAmbientes" :key="ambiente.idambiente" v-if="ambiente.codambiente.substr(1,1)==fsa">
                ...
                <div class="card-body">
                    <table align="center" v-if="regAsignacion.idasignacion">
                        <tr><td class="titcampo">Defunción:</td>  
                            <td v-text="jsfechas.fechames(regAsignacion.fechadefuncion)"></td></tr>
                        ...
                        <tr><td class="titcampo" valign="top">Estadía cumplida:</td> 
                        ...
                        <tr><td class="titcampo" valign="top">Documentos:</td></tr>
                        <tr><td colspan="2"><ul style="list-style:none; padding-left:10px">
                ...
                <div class="card-body">
                    <table v-if="regAsignacion.fechasalida">
                        <tr><td class="titcampo" nowrap>Fecha Exhumacion:</td>
                            <td v-text="jsfechas.fechalat(regAsignacion.fechasalida)"></td></tr>
                        <tr><td class="titcampo" valign="top">Responsable:</td>
                            <td v-text="regResponsable.nombre+' '+regResponsable.apaterno"></td></tr>
                        <tr><td class="titcampo">Parentesco:</td>       
                            <td v-text="regResponsable.parentesco"></td></tr>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" v-if="proceso=='inh'" style="padding-top:10px;">                        
                        ...
                        <ul style="list-style:none; padding-left:5px;">
                            <li v-for="documento in arrayDocumentos" :key="documento.iddocumento">
                            <input type="checkbox" v-model="arrayPresentados" :value="documento.iddocumento" readonly>
                            <span v-text="documento.nomdocumento"></span>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-4" :class="{'col-md-6':proceso=='exh'}" style="padding-top:10px;">                        
                        ...
                        <table>
                            <tr><td nowrap>Nombre: <span class="txtvalidador">*</span></td>
                                <td><select @change="listaResponsables(idresponsable),validarInh()" class="form-control" v-model="idresponsable">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <table>
                                <tr>
                                    <td>Responsable:</td>
                                    <td><select @change="listaResponsables(idresponsable),validarPago()" class="form-control" v-model="idresponsable">
                                            <option v-for="beneficiario in arrayBeneficiarios" :key="beneficiario.idbeneficiario"
                                                :value="beneficiario.idbeneficiario" v-text="beneficiario.nombre+' '+beneficiario.apaterno">
                                            </option>
                                            <option value="0">Otro...</option>
                        ...
                        <div class="col-md-4">
                            <table>
                                <tr><td nowrap>Importe: <font color="#4dbd74"><b>*</b></font></td>
...
export default {
    data(){return { piso:1,
        modalAsignar:0, modalPagos:0, accion:1, completo:0, divNovalido:'',
        divAmbientes:1, arrayAmbientes:[], arrayOcupantes:[], jsfechas:'',
        arrayAmbientes:[], arrayBeneficiarios:[],
        arrayDocumentos:[], arrayPresentados:[], arrayPerfiles:[],        
        regServicio:[], regCliente:[], regAmbiente:[], regResponsable:[],
        regAsignacionPrevio:[], regAmbientePrevio:[],
        sector:'', bloque:'', selnicho:'A', selsarco:'', selfosa:'',
        bloques:'',filas:'',cajas:'', proceso:'',
    ...
    methods:{
        ...
        asignarCliente(ambiente){   
            ...
            if(this.sector=='S') {   
                ...
                console.log(this.regAsignacionPrevio);
                this.regAsignacion='';
                this.arrayPagos='';
                return;
            }
        ...
        listaBeneficiarios(idcliente){
            ...
            axios.get(url).then(function(response){
                ...
                me.listaResponsables(me.regAsignacion.idresponsable);//ficha de entrada
        ...
        listaResponsables(idbeneficiario){
            if(idbeneficiario==0) {
        ...
        traslado(destino){
            ...
            switch(destino){
                ...
                case 'R': alert('dirigir al inicio de mausoleo');break;
            }
        },
