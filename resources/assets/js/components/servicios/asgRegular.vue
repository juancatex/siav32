            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    <tr v-for="ambiente in arrayAmbientes" :key="ambiente.id">
                        ...
                        <td>
                            Canon: <span v-text="ambiente.tarifasocio"></span>Bs.
                        </td>
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <span class="titcampo">Tienda:</span>
        ...
        <div class="modal-dialog modal-primary">
            <div class="modal-content animated fadeIn">
                ...
                <div class="modal-body" style="overflow-y:scroll; height:420px;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <span class="titcampo">Tienda:</span> <span v-text="regAmbiente.codambiente"></span>
                        </div>
                        <div class="col-md-6 text-right">
