...
class Fil_OficinasSeeder extends Seeder
{
    ...
    {       
        ...
        DB::table('fil__oficinas')->insert(['idfilial'=>1,'idunidad'=>8,'codoficina'=>'01','nomoficina'=>'MULTIFAMILIAR JUANCITO PINTO']);
        DB::table('fil__oficinas')->insert(['idfilial'=>1,'idunidad'=>8,'codoficina'=>'02','nomoficina'=>'CASA COMUNITARIA']);
        DB::table('fil__oficinas')->insert(['idfilial'=>1,'idunidad'=>8,'codoficina'=>'03','nomoficina'=>'CAMPOS DEPORTIVOS']);
        DB::table('fil__oficinas')->insert(['idfilial'=>1,'idunidad'=>8,'codoficina'=>'05','nomoficina'=>'SALONES ASCINALSS']);
        DB::table('fil__oficinas')->insert(['idfilial'=>1,'idunidad'=>9,'codoficina'=>'01','nomoficina'=>'DEPTO DE RECURSOS HUMANOS']);
        DB::table('fil__oficinas')->insert(['idfilial'=>1,'idunidad'=>9,'codoficina'=>'02','nomoficina'=>'CONSERJERÍAS']);
        DB::table('fil__oficinas')->insert(['idfilial'=>1,'idunidad'=>10,'codoficina'=>'01','nomoficina'=>'DEPTO DE RRPP']);
        DB::table('fil__oficinas')->insert(['idfilial'=>1,'idunidad'=>11,'codoficina'=>'01','nomoficina'=>'STRIA. PRENSA']);
        DB::table('fil__oficinas')->insert(['idfilial'=>1,'idunidad'=>12,'codoficina'=>'01','nomoficina'=>'ARCHIVO GENERAL']);
