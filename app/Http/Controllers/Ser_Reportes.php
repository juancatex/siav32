...
class Ser_Reportes extends Controller
{
    ...
    {   
      if (!$request->ajax()) return redirect('/'); 
        ...
        // 'REP_REGISTRO' => 'http://localhost'.$rutas['REP_REGISTRO'].'&user='.Auth::user()->username.'&id=',        
        // 'REP_REGISTRO_TODO' => 'http://localhost'.$rutas['REP_REGISTRO_TODO'].'&user='.Auth::user()->username.'&id=',        
        // 'REP_REGISTRO_SALIDA' => 'http://localhost'.$rutas['REP_REGISTRO_SALIDA'].'&user='.Auth::user()->username.'&id=',        
        // 'REP_PERMANENTE' => 'http://localhost'.$rutas['REP_PERMANENTE'].'&user='.Auth::user()->username.'&id=',        
        // 'REP_PERMANENTE_SOCIO' => 'http://localhost'.$rutas['REP_PERMANENTE_SOCIO'].'&user='.Auth::user()->username,        
        // 'REP_ENTRADACC' => 'http://localhost'.$rutas['REP_ENTRADACC'].'&user='.Auth::user()->username,       
        // 'REP_SALIDACC' => 'http://localhost'.$rutas['REP_SALIDACC'].'&user='.Auth::user()->username,        
